...
def generate_random_file():
    ...
    file_path = os.path.join(output_directory, 'random_file1.txt')
...
generate_files_task = PythonOperator(
    ...
    provide_context=False,  # Don't pass context as an argument
    dag=dag,
)
...
upload_to_gcs_task = PythonOperator(
    ...
    op_args=[bucket_name, "{{ ti.xcom_pull(task_ids='generate_random_files') }}", 'random_files/random_file1.txt'],
    dag=dag,
)
